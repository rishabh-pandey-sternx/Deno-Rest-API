  ...
  (function (t, e) {
        ...
        return n.next = function () {
          ...
          n.nextWhenVisible = function () {
            !document.hidden && e(this._element).is(":visible") &&
              "hidden" !== e(this._element).css("visibility") && this.next();
          },
          n.prev = function () {
            ...
            if (
              "next" === t
                ...
                : (i = "carousel-item-right",
                  ...
                  r = "right"), u && e(u).hasClass("active")
            ) {
              this._isSliding = !1;
            } else if (
              !this._triggerSlideEvent(u, r).isDefaultPrevented() && a && u
            ) {
              this._isSliding = !0,
                f && this.pause(),
              ...
              var d = e.Event(
                "slid.bs.carousel",
                { relatedTarget: u, direction: r, from: c, to: h },
              );
      ...
      S = function () {
        ...
        return n.toggle = function () {
          ...
          n.show = function () {
            var n, i, o = this;
            if (
              !this._isTransitioning && !e(this._element).hasClass("show") &&
              (this._parent &&
                0 ===
                  (n = [].slice.call(
                ...
                (n = null),
                !(n && (i = e(n).not(this._selector).data("bs.collapse")) &&
                  i._isTransitioning))
            ) {
              ...
              if (e(this._element).trigger(r), !r.isDefaultPrevented()) {
                ...
                e(this._element).removeClass("collapse").addClass("collapsing"),
                  ...
                  e(this._triggerArray).removeClass("collapsed").attr(
                    "aria-expanded",
                    !0,
                  ),
                ...
                e(this._element).one(
                  l.TRANSITION_END,
                  (function () {
                    e(o._element).removeClass("collapsing").addClass(
                      "collapse show",
                    ),
                      o._element.style[s] = "",
            ...
            if (!this._isTransitioning && e(this._element).hasClass("show")) {
              ...
              if (e(this._element).trigger(n), !n.isDefaultPrevented()) {
                ...
                this._element.style[i] =
                  ...
                  e(this._element).addClass("collapsing").removeClass(
                    "collapse show",
                  );
                ...
                e(this._element).one(
                  ...
                  (function () {
                    t.setTransitioning(!1),
                      e(t._element).removeClass("collapsing").addClass(
                        "collapse",
          ...
          t._jQueryInterface = function (n) {
            return this.each(
              (function () {
                ...
                if (
                  !o && r.toggle && "string" == typeof n &&
                  /show|hide/.test(n) && (r.toggle = !1),
    ...
    function W(t, e, n, i) {
      return Math.max(
        ...
        n["scroll" + t],
        F(10)
          ? parseInt(n["offset" + t]) + parseInt(
            i[
              "margin" + ("Height" === t ? "Top" : "Left")
            ],
        ...
        modifiers: {
            ...
            fn: function (t, e) {
              ...
              var c = e.priority,
                ...
                h = {
                  primary: function (t) {
                    var n = u[t];
                    return u[t] < l[t] && !e.escapeWithReference &&
                      (n = Math.max(u[t], l[t])),
                      z({}, t, n);
                  },
              ...
              return s.forEach(
                (function (a, l) {
                  ...
                  var c = t.offsets.popper,
                    ...
                    v = "left" === i && d || "right" === i && p ||
                      "top" === i && m || "bottom" === i && g,
                    _ = -1 !== ["top", "bottom"].indexOf(i),
                    b = !!e.flipVariations &&
                      (_ && "start" === r && d || _ && "end" === r && p ||
                        !_ && "start" === r && m || !_ && "end" === r && g),
                    y = !!e.flipVariationsByContent &&
                      (_ && "start" === r && p || _ && "end" === r && d ||
          ...
          inner: {
            ...
            fn: function (t) {
              ...
              return o[s ? "left" : "top"] = r[n] -
                (a ? o[s ? "width" : "height"] : 0),
                t.placement = st(e),
          ...
          hide: {
            ...
            fn: function (t) {
              ...
              if (
                e.bottom < n.top || e.left > n.right || e.top > n.bottom ||
                e.right < n.left
              ) {
    ...
    var It = "dropdown",
      ...
      Ft = function () {
        ...
        return n.toggle = function () {
          if (
            !this._element.disabled && !e(this._element).hasClass("disabled")
          ) {
                  ...
                  if (
                    ...
                    e(s).trigger(u),
                      ...
                      ("ontouchstart" in document.documentElement &&
                        ...
                        e(s).removeClass("show").trigger(
                          e.Event("hidden.bs.dropdown", l),
                        ));
                  }
                }
              }
          ...
          t._dataApiKeydownHandler = function (n) {
            if (
              !(/input|textarea/i.test(n.target.tagName) ? 32 === n.which ||
                27 !== n.which &&
        ...
        return n.toggle = function (t) {
          ...
          n._showElement = function (t) {
            var n = this,
              ...
              o = this._dialog ? this._dialog.querySelector(".modal-body")
              : null;
          ...
          n._setEscapeEvent = function () {
            var t = this;
            this._isShown ? e(this._element).on(
          ...
          n._showBackdrop = function (t) {
            ...
            if (this._isShown && this._config.backdrop) {
              ...
              e(this._backdrop).one(l.TRANSITION_END, t).emulateTransitionEnd(
                o,
              );
              ...
              if (e(this._element).hasClass("fade")) {
                ...
                e(this._backdrop).one(l.TRANSITION_END, r).emulateTransitionEnd(
                  s,
                );
              }
              elser();
          ...
          n._setScrollbar = function () {
            ...
            if (this._isBodyOverflowing) {
              ...
              e(document.body).data("padding-right", o).css(
                "padding-right",
      ...
      for (
        var i = (new window.DOMParser()).parseFromString(t, "text/html"),
          ...
          s = function (t, n) {
            ...
            if (
              -1 === o.indexOf(i.nodeName.toLowerCase())
            ) {
        ...
        return n.enable = function () {
          ...
          n.dispose = function () {
            clearTimeout(this._timeout),
              ...
              e(this.element).closest(".modal").off(
                "hide.bs.modal",
          ...
          n.hide = function (t) {
            var n = this,
              ...
              r = function () {
                "show" !== n._hoverState && i.parentNode &&
          ...
          n.setElementContent = function (t, n) {
            "object" != typeof n || !n.nodeType && !n.jquery
              ? this.config.html ? (this.config.sanitize &&
                ...
                t.html(n)) : t.text(n)
              : this.config.html ? e(n).parent().is(t) || t.empty().append(n)
              : t.text(e(n).text());
          },
          n.getTitle = function () {
          ...
          n._getContainer = function () {
            return !1 === this.config.container ? document.body
            : l.isElement(this.config.container) ? e(this.config.container)
          ...
          n._setListeners = function () {
            ...
            this.config.trigger.split(" ").forEach(
              (function (n) {
                if ("click" === n) {
                  ...
                  var i = "hover" === n
                    ...
                    o = "hover" === n ? t.constructor.Event.MOUSELEAVE
              ...
              e(this.element).closest(".modal").on(
                "hide.bs.modal",
                this._hideModalHandler,
              ),
      ...
      fe = function () {
        function t(t, n) {
          ...
          this._element = t,
            ...
            this._selector = this._config.target + " .nav-link," +
              this._config.target + " .list-group-item," + this._config.target +
              " .dropdown-item",
            this._offsets = [],
            this._targets = [],
        ...
        return n.refresh = function () {
          ...
          n._activate = function (t) {
            ...
            var n = this._selector.split(",").map(
                (function (e) {
            ...
            i.hasClass("dropdown-item")
              ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(
                "active",
              ),
                i.addClass("active"))
              : (i.addClass("active"),
                i.parents(".nav, .list-group").prev(
                  ".nav-link, .list-group-item",
                ).addClass("active"),
                i.parents(".nav, .list-group").prev(".nav-item").children(
                  ".nav-link",
                ).addClass("active")),
              ...
              (function () {
                ...
                if (
                  ...
                  (i = new t(this, "object" == typeof n && n),
                    e(this).data("bs.scrollspy", i)), "string" == typeof n
                ) {
                  if ("undefined" == typeof i[n]) {
                    throw new TypeError(
                      'No method named "' + n + '"',
      ...
      pe = function () {
        ...
        return n.show = function () {
          ...
          if (
            ...
            if (o) {
              var s = "UL" === o.nodeName || "OL" === o.nodeName
                ? "> li > .active"
                : ".active";
          ...
          n._activate = function (t, n, i) {
            ...
            if (r && s) {
              ...
              e(r).removeClass("show").one(l.TRANSITION_END, a)
                .emulateTransitionEnd(c);
            }
            elsea();
          },
          ...
          if (e(this._element).trigger(n), !n.isDefaultPrevented()) {
            ...
            var i = function () {
              t._element.classList.remove("showing"),
                ...
                t._config.autohide && (t._timeout = setTimeout(
                  (function () {
                    t.hide();
                  }),
                  t._config.delay,
              ...
              (function () {
                ...
                if (
                  ...
                  (o = new t(this, "object" == typeof n && n),
                    i.data("bs.toast", o)), "string" == typeof n
                ) {
                  if ("undefined" == typeof o[n]) {
                    throw new TypeError(
                      'No method named "' + n + '"',
