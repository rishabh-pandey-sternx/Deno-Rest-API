...
!function (t, e) {
  ...
  (function (t, e, n) {
    ...
    e = e && Object.prototype.hasOwnProperty.call(e, "default") ? e.default : e,
      n = n && Object.prototype.hasOwnProperty.call(n, "default")
        ? n.default
        : n;
    function l(t) {
      var n = this, i = !1;
        ...
        for (var i in n) {
          if (Object.prototype.hasOwnProperty.call(n, i)) {
            ...
            if (!new RegExp(o).test(r)) {
              throw new Error(
                t.toUpperCase() + ': Option "' + i + '" provided type "' + r +
                  '" but expected type "' + o + '".',
              );
            }
          }
      ...
      E = function () {
        ...
        return n.next = function () {
          ...
          n._getItemByDirection = function (t, e) {
            ...
            return -1 === r ? this._items[this._items.length - 1]
            : this._items[r];
          },
            ...
            if (
              "next" === t
                ...
                : (i = "carousel-item-right",
                  ...
                  s = "right"), h && e(h).hasClass("active")
            ) {
              this._isSliding = !1;
            } else if (
              !this._triggerSlideEvent(h, s).isDefaultPrevented() && a && h
            ) {
              this._isSliding = !0,
                d && this.pause(),
        ...
        function t(t, e) {
          ...
          for (
            ...
            var s = n[i],
              ...
              a = [].slice.call(document.querySelectorAll(r)).filter(
                (function (e) {
                  return e === t;
                }),
              );
          ...
          t._jQueryInterface = function (n) {
            return this.each(
              (function () {
                ...
                if (
                  !o && s.toggle && "string" == typeof n &&
                  /show|hide/.test(n) && (s.toggle = !1),
        ...
        return n.toggle = function (t) {
          ...
          n._showBackdrop = function (t) {
            ...
            if (this._isShown && this._config.backdrop) {
              ...
              e(this._backdrop).one(c.TRANSITION_END, t).emulateTransitionEnd(
                o,
              );
              ...
              if (e(this._element).hasClass("fade")) {
                ...
                e(this._backdrop).one(c.TRANSITION_END, s).emulateTransitionEnd(
                  r,
                );
              }
              elses();
      ...
      $ = function () {
        ...
        return i.enable = function () {
          ...
          i._getContainer = function () {
            ...
            : c.isElement(this.config.container) ? e(this.config.container)
        ...
        return n.show = function () {
          ...
          n._activate = function (t, n, i) {
            ...
            if (s && r) {
              ...
              e(s).removeClass("show").one(c.TRANSITION_END, a)
                .emulateTransitionEnd(l);
            }
            elsea();
          },
