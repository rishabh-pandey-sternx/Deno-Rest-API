...
(function ($, window, document, undefined) {
  ...
  Owl.prototype.update = function () {
    ...
    while (i < n) {
      if (
        this._invalidated.all || $.grep(this._pipe[i].filter, filter).length > 0
      ) {
    ...
    if (!this.settings.freeDrag) {
      ...
      $.each(
        ...
        $.proxy(function (index, value) {
          ...
          if (
            direction === "left" && coordinate > value - pull &&
            ...
            direction === "right" && coordinate > value - width - pull &&
  ...
  Owl.prototype.to = function (position, speed) {
    ...
    if (this.settings.loop) {
      ...
      if (
        revert !== position && revert - distance <= maximum &&
        revert - distance > 0
      ) {
  ...
  Owl.prototype.replace = function (content) {
    ...
    content.filter(function () {
      ...
      this._mergers.push(
        item.find("[data-merge]").addBack("[data-merge]").attr(
              "data-merge",
            ) * 1 || 1,
      );
    }, this));
  ...
  Owl.prototype.add = function (content, position) {
    ...
    if (this._items.length === 0 || position === this._items.length) {
      ...
      this._mergers.push(
        content.find("[data-merge]").addBack("[data-merge]").attr(
              "data-merge",
            ) * 1 || 1,
      );
    } else {
    ...
    $elements.each($.proxy(function (index, element) {
      var $element = $(element),
        ...
        url =
          ...
          $element.attr("data-src") || $element.attr("data-srcset");
...
(function ($, window, document, undefined) {
  ...
  Video.prototype.play = function (event) {
    ...
    if (video.type === "youtube") {
      html.attr(
        "src",
        "//www.youtube.com/embed/" + video.id + "?autoplay=1&rel=0&v=" +
          video.id,
      );
    } else if (video.type === "vimeo") {
    ...
    iframe = $(html).wrap('<div class="owl-video-frame" />').insertAfter(
      item.find(".owl-video"),
    );
    ...
    this._handlers = {
      "changed.owl.carousel": $.proxy(function (e) {
        if (e.namespace && e.property.name === "settings") {
          ...
          e.namespace && e.property.name === "position" && this._paused
        ) {
        ...
        if (e.namespace && this._core.settings.dotsData) {
          this._templates.push(
            '<div class="' + this._core.settings.dotClass + '">' +
              $(e.content).find("[data-dot]").addBack("[data-dot]").attr(
                "data-dot",
              ) + "</div>",
          );
        }
  ...
  Navigation.prototype.initialize = function () {
    ...
    this._controls.$relative =
      (settings.navContainer
        ? $(settings.navContainer)
        : $("<div>").addClass(settings.navContainerClass).appendTo(
          this.$element,
        )).addClass("disabled");
...
(function ($, window, document, undefined) {
  ...
  var Hash = function (carousel) {
    ...
    this._handlers = {
      ...
      "prepared.owl.carousel": $.proxy(function (e) {
        if (e.namespace) {
          var hash = $(e.content).find("[data-hash]").addBack("[data-hash]")
            .attr("data-hash");
