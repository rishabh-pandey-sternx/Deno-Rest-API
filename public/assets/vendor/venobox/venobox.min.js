        ...
        this.each(function () {
          ...
          function K() {
            _ = D.data("gall"),
              ...
              "inline" !== D.data("vbtype") && "ajax" !== D.data("vbtype") &&
              (Q = {
                pinterest:
                  '<a target="_blank" href="https://pinterest.com/pin/create/button/?url=' +
                  D.prop("href") + "&media=" + D.prop("href") +
                  "&description=" + y + '">' + T + "</a>",
                facebook:
            ...
            return !(e.length < 1) &&
              (!g &&
                (g = !0,
                  ...
                  e === z &&
                  d.addClass("vbox-animated").addClass("swipe-right"),
                  e === C &&
                  d.addClass("vbox-animated").addClass("swipe-left"),
                  E.show(),
                  void d.animate({ opacity: 0 }, 500, function () {
                    w.css("background", x),
                      d.removeClass("vbox-animated").removeClass("swipe-left")
          ...
          L.VBclose = function () {
            ...
            D.on("click", function (h) {
              if (
                h.preventDefault(), D = e(this), !1 === ee.cb_pre_open(D)
              ) {
                return !1;
              }
              switch (
              ...
              return M += "</div>",
                O = '<a class="vbox-next">' + ee.htmlNext +
                  '</a><a class="vbox-prev">' + ee.htmlPrev + "</a>",
                V =
                  '<div class="vbox-title"></div><div class="vbox-left"><div class="vbox-num">0/0</div></div><div class="vbox-close">' +
                  ee.htmlClose + "</div>",
                '<div class="vbox-share"></div>',
                l = '<div class="vbox-overlay ' + v + '" style="background:' +
                  x + '">' + M +
                  '<div class="vbox-container"><div class="vbox-content"></div></div>' +
                  V + O + '<div class="vbox-share"></div></div>',
                e("body").append(l).addClass("vbox-open"),
                e(".vbox-preloader div:not(.sk-circle) .sk-child, .vbox-preloader .sk-rotating-plane, .vbox-preloader .sk-rect, .vbox-preloader div:not(.sk-folding-cube) .sk-cube, .vbox-preloader .sk-spinner-pulse")
          ...
          ee.overlayClose || (te = ".vbox-close"),
            e("body").on("click touchstart", te, function (s) {
              (e(s.target).is(".vbox-overlay") ||
                ...
                e(s.target).is(".vbox-container")) && ae();
            }),
            R = 0,
            Y = 0,
            W = 0,
          ...
          var le = {
            ...
            ne = function (s) {
              ...
              a = i == le.UP
                ? ve(i, s, null, null)
                : ve(i, s, t.pageX, t.pageY), e(s.target).trigger(a);
            },
            ve = function (s, i, a, t) {
              return e.Event(s, { pageX: a, pageY: t, originalEvent: i });
            };
          function ue() {
            e.ajax({ url: n, cache: !1 }).done(function (e) {
          ...
          function ge() {
            c.html(y),
              d.find(">:first-child").addClass("vbox-figlio").css(
                { width: u, height: b, padding: r, background: i },
              ),
