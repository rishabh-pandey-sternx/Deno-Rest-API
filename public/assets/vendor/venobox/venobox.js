    ...
    venobox: function (options) {
      ...
      return this.each(function () {
        ...
        obj.on("click", function (e) {
          ...
          navigation = '<a class="vbox-next">' + option.htmlNext +
            '</a><a class="vbox-prev">' + option.htmlPrev + "</a>";
          vbheader =
            '<div class="vbox-title"></div><div class="vbox-left"><div class="vbox-num">0/0</div></div><div class="vbox-close">' +
            option.htmlClose + "</div>";
          ...
          core = '<div class="vbox-overlay ' + extraCss +
            ...
            vbheader + navigation + vbfooter + "</div>";
        ...
        function checknav() {
          ...
          if (
            ...
            obj.data("vbtype") !== "inline" && obj.data("vbtype") !== "ajax"
          ) {
            sharelinks = {
              pinterest:
                '<a target="_blank" href="https://pinterest.com/pin/create/button/?url=' +
                obj.prop("href") + "&media=" + obj.prop("href") +
                "&description=" + title + '">' + pinIcon + "</a>",
              facebook:
                '<a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=' +
                obj.prop("href") + '">' + fbIcon + "</a>",
              twitter:
                '<a target="_blank" href="https://twitter.com/intent/tweet?text=' +
                title + "&url=" + obj.prop("href") + '">' + twitterIcon +
                "</a>",
              linkedin:
                '<a target="_blank" href="https://www.linkedin.com/sharing/share-offsite/?url=' +
                obj.prop("href") + '">' + linkedinIcon + "</a>",
              download: '<a target="_blank" href="' + obj.prop("href") + '">' +
                downloadIcon + "</a>",
            };
        ...
        function navigateGall(destination) {
          ...
          overlayColor = destination.data("overlay") ||
          ...
          title = (destination.data("titleattr") &&
        ...
        function loadVid(autoplay) {
          ...
          content.html(
            '<iframe class="venoframe vbvid" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="autoplay" frameborder="0" src="' +
              player + videoObj.id + queryvars + '"></iframe>',
          );
          updateoverlay();
        }
        ...
        function getUrlParameter(name) {
          ...
          if (firstsplit[1] !== undefined) {
            ...
            for (i = 0; i < sURLVariables.length; i++) {
              ...
              result = result + "&" + sParameterName[0] + "=" +
                sParameterName[1];
            }
          }
